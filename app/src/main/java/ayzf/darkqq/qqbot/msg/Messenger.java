...
public class Messenger implements Parcelable {
    ...
    public Messenger(Parcel parcel) {
        parcel.readList(this.data, super.getClass().getClassLoader());
    }
    ...
    public Messenger addMsg(String tag, String value) {
        for (HashMap<String, String> maps : this.data) {
            if (!maps.containsKey(tag)) {
                if (tag.equals(Msg.Text) || tag.equals(Msg.Img) || tag.equals(Msg.Emoid)) {
                    if (maps.containsKey(Msg.Text) || maps.containsKey(Msg.Img) || maps.containsKey(Msg.Emoid)) {
                        break;
                    }
                }
